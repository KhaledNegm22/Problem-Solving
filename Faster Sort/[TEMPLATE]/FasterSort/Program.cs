    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (cki.Key == ConsoleKey.D1 || cki.Key == ConsoleKey.D2 || cki.Key == ConsoleKey.D3)
            {
                ...
                //GENERATE TEST CASES
                /********************/
                //problem.GenerateTestCases(HardniessLevel.Easy, 10);
                //problem.GenerateTestCases(HardniessLevel.Hard, 20);

                //problem.GenerateTestCases(HardniessLevel.Hard, 1, true, 1.8f);
                /*****************************************************************/
